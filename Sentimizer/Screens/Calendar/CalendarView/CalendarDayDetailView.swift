...
struct CalendarDayDetailView: View {
    ...
    @State private var content: [CalendarModel] = []
...
struct CalendarDayDetailView_Previews: PreviewProvider {
    static var previews: some View {
        CalendarDayDetailView(data: [CalendarModel(date: Date(), activity: "Walk", icon: "figure.walk"), CalendarModel(date: Date(), activity: "Walk", icon: "figure.walk"), CalendarModel(date: Date(), activity: "Walk", icon: "figure.walk"), CalendarModel(date: Date(), activity: "Walk", icon: "figure.walk"), CalendarModel(date: Date(), activity: "Walk", icon: "figure.walk"), CalendarModel(date: Date(), activity: "Walk", icon: "figure.walk"), CalendarModel(date: Date(), activity: "Walk", icon: "figure.walk")], date: Date())
    }
}
